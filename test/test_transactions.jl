...
@testset "one task, flat spans (serial execution)" begin
    expected = (("root_span", "0"), [
        (("span1", "1"), []),
        (("span2", "2"), []),
    ])

    tps = start_transaction(; name="transaction", op="root_span", description="0") do t
...
@testset "async tasks, separate transactions" begin
    t0, t1, t2 = start_transaction(; name="transaction", op="root_span", description="0") do t
        t1 = nothing
        t2 = nothing
        @sync begin
